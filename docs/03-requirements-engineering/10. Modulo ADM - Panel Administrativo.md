# 10. Módulo ADM — Panel Administrativo, Control de Acceso y Métricas

### 1. Metadatos del Documento
- **Proyecto:** Adí (Gestión de Inventario y CRM de Calzado Deportivo)
- **Fase:** 3 — Ingeniería de Requisitos
- **Entregable:** 10 de 12 (Especificación de Módulo: `MOD-ADM`)
- **Módulo:** `MOD-ADM` (Panel de Administración Web, Autenticación JWT, RBAC y Dashboard)
